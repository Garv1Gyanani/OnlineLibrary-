                          ...
                          children: [
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'these are the books you may like',
                                    style: TextStyle(
                                      fontSize: 36,
                            ...
                            _buildBookSection(horizontalPadding, 'Love!', 0, 10),
                            SizedBox(height: 20),
                            _buildBookSection(horizontalPadding, 'Fiction!', 5, 15),
                            SizedBox(height: 20),

                            _buildBookSection(horizontalPadding, 'Adult Reading!', 15, 25),
